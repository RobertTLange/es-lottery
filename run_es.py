...
def main(config, log):
    ...
    for iter_id in range(1, config.num_imp_iters + 1):
        ...
        (
            ...
            summary,
            thresh,
        ) = imp_baselines.apply(rng_mask, iter_id, pruning_ckpt, pruning_sigma)
...
if __name__ == "__main__":
    ...
    mle = MLExperiment(config_fname="configs/gym.yaml")
